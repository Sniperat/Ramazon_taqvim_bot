...
class Region(models.Model):
    ...
    reg_bamdod = models.TimeField(auto_now=False, null=True, default=None)
    reg_tong = models.TimeField(auto_now=False, null=True, default=None)
    reg_peshin = models.TimeField(auto_now=False, null=True, default=None)
    reg_asr = models.TimeField(auto_now=False, null=True, default=None)
    reg_shom = models.TimeField(auto_now=False, null=True, default=None)
    reg_xufton = models.TimeField(auto_now=False, null=True, default=None)
